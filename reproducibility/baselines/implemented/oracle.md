...
Uses access to realized next-step outcomes to choose updates with hindsight-like information.

## Role in evaluation

Non-causal upper-bound/reference, not a deployable competitor.
